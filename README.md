...
## Usage
To create a candidate search application that calls the GitHub API and renders data in the browser.
...
WHEN I click the "-" button
THEN the next candidate's information should be displayed without saving the current candidateplatform (Stack Overflow, Twitter)
```